  ...
  return (
    <div className="projet-page">
      ...
      <div className="projet-content page-padding">
        {/* Header */}
        <div className="projet-header animate-slide-in animate-delay-1">
        ...
        <div className="projet-filters animate-slide-in animate-delay-2">
        ...
        {loading ? (
          ...
          <div className="projets-grid animate-slide-in animate-delay-3">
        ...
        {/* Statistiques */}
        <div className="projet-stats animate-slide-in animate-delay-4">
